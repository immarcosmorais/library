...
public class AuthorController {
    ...
    @PostMapping
    public ResponseEntity save(@RequestBody @Valid AuthorBody authorBody, UriComponentsBuilder uriBuilder) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity update(@PathVariable Long id, @RequestBody @Valid AuthorBody authorBody) {
